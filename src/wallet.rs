...
pub struct Wallet {
    ...
    /// Unconfirmed transferred funds amount.
...
impl Wallet {
    ...
    /// Return a copy of this wallet with updated frozen_amount.
    pub fn set_frozen_amount(self, frozen_amount: u64, history_hash: &Hash) -> Self {
        Self::new(
            &self.pub_key,
            &self.name,
            self.balance,
